...
/**
 * Creeps are your units. Creeps can move, harvest energy, construct structures, attack another creeps, and perform other actions. Each creep consists of up to 50 body parts with the following possible typings:
 */
...
interface BodyPartDefinition {
    ...
    /**
     * One of the body part typings constants.
     */
...
interface StructureLab extends OwnedStructure<STRUCTURE_LAB> {
     ...
     * @param bodyPartsCount The number of body parts of the corresponding type to be boosted. Body parts are always counted left-to-right for TOUGH, and right-to-left for other typings. If undefined, all the eligible body parts are boosted.
     */
...
/**
 * A discriminated union on Structure.type of all owned structure typings
 */
...
/**
 * A discriminated union on Structure.type of all structure typings
 */
